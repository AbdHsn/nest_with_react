...
const LoginTabset = () => {
  ...
  const routeChange = () => {
    let data = {
      name: "Abdullah Bin Hasan",
      token: "xxlkjkddkek923320055kdkfa.sdkfasdk.ddafdsd234",
      module: 1,
    };
    saveToken(data)
      .then(() => {
        window.location.href = "/";
        console.log("Auth Data:", JSON.parse(localStorage.getItem("user")));
      })
      .catch((err) => console.log("Failed to saveToken"));
  };
  return (
    <div>
      <Fragment>
